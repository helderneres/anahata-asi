 ...
 * <p>
 * This toolkit is primarily used during 'History Compression' turns where 
 * the model is forced to evaluate its own context window and decide which 
...
public class History extends AnahataToolkit {
    ...
    public List<String> getSystemInstructions() throws Exception {
        ...
        s+= "\n\nThe History toolkit allows you to:\n"                
                ...
                + "\n -PINED"
                + "\n -AUTO"
                + "b) Configure history metadata position: ('In-band Metadata injection' vs 'Consolidated Metadata Index in RAG message').\n"
    ...
    public void populateMessage(RagMessage ragMessage) throws Exception {
        ...
        sb.append("- **Active History Metadata Strategy**: ").append(getAgi().getRequestConfig().isInjectInbandMetadata()).append("\n");
        ...
        if (!getAgi().getRequestConfig().isInjectInbandMetadata()) {
            sb.append("\n**Consolidated History Metadata**: (In-band Metadata Injection is currently disabled)\n");
